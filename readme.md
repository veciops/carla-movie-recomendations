...
O sistema foi construído com base no algoritmo [KNN](https://en.wikipedia.org/wiki/K-nearest_neighbors_algorithm) e em um conjunto de dados de características de filmes baixados do  [Kaggle](https://www.kaggle.com/shivamsinghal1012/smart-phones-details) . Para construir o projeto, foi usada a implementação do KNN existente na biblioteca scikit-learn .
